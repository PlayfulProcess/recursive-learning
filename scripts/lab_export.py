...
PAPERS = [
    ...
    ("book", "axelrod-1984", "The Evolution of Cooperation", ["Robert Axelrod"], 1984, "Basic Books",
     "https://fee.org/articles/book-review-the-evolution-of-cooperation-by-robert-axelrod/", None, "thread-cooperation", LIT,
     ...
     "The lab cites a review of the book (FEE), not the book itself."),
