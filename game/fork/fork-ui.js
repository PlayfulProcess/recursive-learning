...
// Pinned to 'example': the merge train swapped tree-adapter.js's PIN to the film renderer (PR #6 landed), which
// flips SOURCE to 'film' and would otherwise auto-load the real explainers/belief-tree/people.json. She has not
// approved showing real people in The Fork yet, so this stays 'example' until she does.
